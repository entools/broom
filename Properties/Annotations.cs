...
namespace EntoolsBroom.Annotations
{
  /// <summary>
  ...
  /// <item>Input    ::= ParameterForFillingName: Value [, Input]*</item>
  /// <item>Output   ::= [ParameterForFillingName: Value]* {halt|stop|void|nothing|Value}</item>
